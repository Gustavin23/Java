...
public class Conta {
	...
	// Atributos
	// Para encapsular (proteger) uma variável devemos usar o modificador private e criar métodos
	// especificos para outras classes e pacotes terem acesso às variáveis
	...
	//Encapsulamento - Passo 2 Criar os métodos específicos (get e set) | Eclipse - botão direito do mouse - Source - 
	// Generate Getters and Setters - selecionar as variáveis encapsulada
	/**
	...
	/**
	 * Método simples com uma variável local e um objeto criado para indicar a conta de destino
	 * da transferência
	 * @param destino
	 * @param valor
	 */
